...
(lib.leaderboarddatefive = function(mode,startPosition,loop) {
	...
	this.shape.setTransform(43.8,2.7);
	...
	this.shape_2 = new cjs.Shape();
	this.shape_2.graphics.f("#FFFFFF").s().p("AAgBrQgIAAgCgBQgBgBAAgHIAAgqIhPAAQgLAAgCgCQgDgCAAgFQAAgLApg4IALgPIALgOQAog5AMAAQAHAAACAEQADADAAAKIAAB6IAOAAQAFAAACABQABABAAAFIAAAKQAAAEgBABQgCABgFAAIgOAAIAAAqQAAAHgCABQgBABgJAAgAgPgOQgQAWgRAZIBFAAIAAhdQgTAVgRAZg");
	this.shape_2.setTransform(18.2,3.1);

	this.shape_3 = new cjs.Shape();
	this.shape_3.graphics.f("#FFFFFF").s().p("AgOAQQgHgHAAgJQAAgIAHgHQAGgGAIAAQAJAAAGAGQAHAHAAAIQAAAJgHAHQgGAGgJAAQgIAAgGgGg");
	this.shape_3.setTransform(-1.1,8.4);
	...
	this.shape_4.setTransform(-12.2,3.5);

	this.shape_5 = new cjs.Shape();
	this.shape_5.graphics.f("#FFFFFF").s().p("AgzA0QgTgUgBgfQAAggAWgUQAVgWAeAAQAfAAAUAVQASATABAfQAAAggVAVQgVAXgeAAQgeAAgVgWgAgagpQgIALgBATQAAAbAMATQAMASARABQANAAAIgMQAJgMAAgSQAAgbgLgTQgMgSgRAAQgOAAgIALg");
	this.shape_5.setTransform(-27.5,3.3);

	this.shape_6 = new cjs.Shape();
	this.shape_6.graphics.f("#FFFFFF").s().p("");
	this.shape_6.setTransform(-46.3,0.2);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape_6},{t:this.shape_5},{t:this.shape_4},{t:this.shape_3},{t:this.shape_2},{t:this.shape_1},{t:this.shape}]}).wait(1));

}).prototype = getMCSymbolPrototype(lib.leaderboarddatefive, new cjs.Rectangle(-59.5,-18.7,113,37.5), null);
...
(lib.greyrectangle = function(mode,startPosition,loop) {
	...
	// Layer 1
	this.shape = new cjs.Shape();
	this.shape.graphics.f().s("#999999").ss(1,1,1).p("Eg5GgG8MByNAAAIAAN5MhyNAAAg");
	this.shape.setTransform(0,0,0.995,1);
